...
class BpayAPI
{
    ...
    {
        // Define the API url
        $api_url = "https://bpay.bryocorp.com/e_merchant/$this->mode/pay_in1/$this->apikey";
    ...
    {
        // Define the API url
        $api_url = "https://bpay.bryocorp.com/e_merchant/$this->mode/pay_in2/$this->apikey";
     ...
     * @param  string $payWith "fiat" or "crypto"
     * @param  string $currency EUR, USD, XOF
     * @param  array $order
     * 
